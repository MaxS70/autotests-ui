...
with sync_playwright() as playwright:
    ...
    courses_results_text = page.get_by_test_id('courses-list-empty-view-description-text')
    expect(courses_results_text).to_be_visible()
    expect(courses_results_text).to_have_text('Results from the load test pipeline will be displayed here')
